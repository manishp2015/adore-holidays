...
<?php if(wpbs_form_check_duplicate_field_ids($form_id, $form_data, $form_meta) == false): ?>
	<!-- Unused fields notice -->
	<div class="notice notice-error"> 
		<p><?php echo __( 'Uh-oh! It looks like you some of your fields have the same ID. Not sure how this happened. Please delete one of the fields and try creating it again.', 'wp-booking-system' ); ?></p>
	</div>
<?php endif ?>
...
<div class="wrap wpbs-wrap wpbs-wrap-edit-form">
    ...
    <form method="POST" action="" autocomplete="off">
        ...
        <div class="wpbs-heading-actions">
            ...
            <!-- Back Button -->
            <a href="<?php echo add_query_arg( array( 'page' => 'wpbs-forms'), admin_url( 'admin.php' ) ); ?>" class="button-secondary"><?php echo __('Back to all forms', 'wp-booking-system') ?></a>
                        ...
                        foreach( $tabs as $tab_slug => $tab_name ) {
                            ...
                            switch($tab_slug){
                                ...
                                case 'email-notifications':
                                    include 'view-edit-form-tab-email-notifications.php';
                                    break;
