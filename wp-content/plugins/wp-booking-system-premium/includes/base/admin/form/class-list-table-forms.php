	...
	public function column_name( $item ) {
		...
		if( $item['status'] == 'active' ) {
			...
			$actions = array(
				...
				'duplicate_form' => '<a href="' . wp_nonce_url( add_query_arg( array( 'page' => 'wpbs-forms', 'wpbs_action' => 'duplicate_form', 'form_id' => $item['id'] ) , admin_url( 'admin.php' ) ), 'wpbs_duplicate_form', 'wpbs_token' ) . '">' . __( 'Duplicate form', 'wp-booking-system' ) . '</a>',
