...
<div class="wpbs-notice-error">
	...
	<p><?php echo __( 'The uninstaller will remove all WP Booking System information stored in the database for version 8 and higher.', 'wp-booking-system' ); ?></p>
	...
	<p><?php echo __( 'Data related to versions lower than version 8 will not be removed.', 'wp-booking-system' ); ?></p>
