module.exports = {
  // Entry.
  entry: "./assets/js/src/script-block-overview-calendar.js", // Import all JavaScript dependencies in this file.

  // Output.
  output: {
    path: __dirname, // Path to produce the output. Set to the current directory.
    filename: "assets/js/build/script-block-overview-calendar.js" // Filename of the file that webpack builds.
  },
