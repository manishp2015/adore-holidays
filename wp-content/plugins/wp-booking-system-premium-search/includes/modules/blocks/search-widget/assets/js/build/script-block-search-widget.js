...
registerBlockType('wp-booking-system/search-widget', {
	...
	edit: function edit(props) {
		...
		return [wp.element.createElement(ServerSideRender, {
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					'p',
					{ 'class': 'description' },
					__('Select the calendars you wish to be included in the search, or leave empty to show all calendars.', 'wp-booking-system-search')
				),
        ...
        wp.element.createElement(SelectControl, {
					...
					options: [{ value: 'yes', label: __('Yes', 'wp-booking-system-search') }, { value: 'no', label: __('No', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
        ...
        wp.element.createElement(SelectControl, {
					...
					options: [{ value: 'yes', label: __('Yes', 'wp-booking-system-search') }, { value: 'no', label: __('No', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
						return props.setAttributes({ mark_selection: new_value });
					} })
			)
		)];
	},
