...
<div id="wpbs-email-reminder-wrapper" class="wpbs-email-reminder-wrapper wpbs-settings-wrapper <?php echo ( !empty($form_meta['reminder_notification_enable'][0]) ) ? 'wpbs-settings-wrapper-show' : '';?>">
    ...
    <div class="wpbs-settings-field-wrapper wpbs-settings-field-inline wpbs-settings-field-large">
        ...
        <div class="wpbs-settings-field-inner">
            <input name="reminder_notification_when_to_send" type="number" min="1" id="reminder_notification_when_to_send" value="<?php echo ( !empty($form_meta['reminder_notification_when_to_send'][0]) ) ? esc_attr($form_meta['reminder_notification_when_to_send'][0]) : '7';?>" class="regular-text" >
    ...
    <div class="wpbs-settings-field-wrapper wpbs-settings-field-inline wpbs-settings-field-large">
        ...
        <div class="wpbs-settings-field-inner">
            <input name="reminder_notification_from_email" type="text" id="reminder_notification_from_email" value="<?php echo ( !empty($form_meta['reminder_notification_from_email'][0]) ) ? esc_attr($form_meta['reminder_notification_from_email'][0]) : (isset($settings['default_from_email']) ? esc_attr($settings['default_from_email']) : '');?>" class="regular-text" >
        </div>
    </div>
